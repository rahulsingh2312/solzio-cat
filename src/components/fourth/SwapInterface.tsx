        ...
        <div className=" border-2 border-black rounded-lg p-3 mb-2">
          ...
          <div className="flex justify-between items-center">
            ...
            <button className="flex items-center bg-black border-white text-white border-2 px-3 py-1 rounded-full">
              <span className="mr-1 border-1 rounded-xl border-white" >             <FaEthereum />
              </span>
          ...
          <div className="bg-yellow-400 items-center justify-center ml-[110px] absolute translate- rounded-full ">
